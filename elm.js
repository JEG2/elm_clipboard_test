...
var _user$project$ClipboardTest$view = function (model) {
	return A2(
...
var Elm = {};
Elm['ClipboardTest'] = Elm['ClipboardTest'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['ClipboardTest'], 'ClipboardTest', typeof _user$project$ClipboardTest$main === 'undefined' ? null : _user$project$ClipboardTest$main);
